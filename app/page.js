  ...
  return (
    <>
      ...
      */}
      ...
      <div className="bg-background-light dark:bg-background-dark text-slate-900 dark:text-white transition-colors duration-300 overflow-x-hidden font-display">
        {/* Navigation */}
        <Header/>
        ...
        {/* Footer */}
        <footer className="bg-gradient-to-t from-orange-400 via-pink-500 to-purple-600 dark:from-orange-900 dark:via-pink-900 dark:to-purple-900 rounded-t-[4rem] relative z-10 pt-32 pb-10 -mt-16">
